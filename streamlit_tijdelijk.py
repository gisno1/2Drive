...
class APIClient:
    ...
    def get_parts(self):
        ...
        wo_259 = self.get_data('GetAftersalesForAffiliateExtended?AffiliateId=259')[['WONUMMER']]
        wo_261 = self.get_data('GetAftersalesForAffiliateExtended?AffiliateId=261')[['WONUMMER']]
    ...
    def get_price_history(self, df, onderdeelnummer):
        ...
        history = df[df['Onderdeelnummer'] == onderdeelnummer][['Onderdeelnummer', 'Verkoopprijs', 'Relatie', 'Vestiging']]
